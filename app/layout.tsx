...
export const metadata = {
  ...
  title: "ArcAlert",
  description: "ArcAlert - an app for those ready for tomorrow",
};

const anton = Anton({
  subsets: ['latin'],
  weight: '400', // Specify the weights you want to include
});
      ...
      <body className="bg-background text-foreground">
        ...
        >
          <main className="min-h-screen flex flex-col items-center">
            <div className="flex-1 w-full flex flex-col items-center min-h-screen flex flex-col">
